...
user in an INI file next to QalculatePortable.exe called QalculatePortable.ini.
...
copy AppNamePortable.ini from this directory to QalculatePortable.ini next to
QalculatePortable.exe. The options in the INI file are as follows:
